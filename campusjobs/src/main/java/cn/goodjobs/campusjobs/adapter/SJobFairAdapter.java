 ...
 */
public class SJobFairAdapter extends JsonArrayAdapterBase<JSONObject> {

    private List<Integer> data = new ArrayList<Integer>();
    private int follow;

    public SJobFairAdapter(Context context) {
        super(context);
    }
    ...
    protected View getExView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_sjobfair, null);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SJobFairDetailsActivity.class);
    ...
    public class ViewHolder {
        private TextView corpName, pubDate, schoolAddress, fairWeek, fairNum, followHas;
    }
}
