...
//    private static final String TAG = "XScrollView";
    ...
    private void initWithContext(Context context) {
        ...
        LinearLayout.LayoutParams mlp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT) ;
        mLayout.setLayoutParams(mlp) ;
        mLayout.setOrientation(LinearLayout.VERTICAL) ;
        mLayout.setGravity(Gravity.CENTER) ;

        LinearLayout.LayoutParams contentViewlp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.WRAP_CONTENT) ;

        mHeadView = new LinearLayout(context) ;
        mHeadView.setLayoutParams(contentViewlp) ;
        mHeadView.setOrientation(LinearLayout.VERTICAL) ;
        mLayout.addView(mHeadView) ;

        mContentView = new LinearLayout(context) ;
        mContentView.setLayoutParams(contentViewlp) ;
        mContentView.setOrientation(LinearLayout.VERTICAL) ;
        mLayout.addView(mContentView) ;

        mFootView = new LinearLayout(context) ;
        mFootView.setLayoutParams(contentViewlp) ;
        mFootView.setOrientation(LinearLayout.VERTICAL) ;
        mLayout.addView(mFootView) ;
    ...
    private void addHeaderView(XHeaderView mHeaderView) {
        ...
        LinearLayout mHeadLayout = mHeadView;
    ...
    private void addFooterView(XFooterView mFooterView) {
        ...
        LinearLayout footLayout = mFootView;
