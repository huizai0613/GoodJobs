 ...
 */
public class ResumeTrainAdapter extends JsonArrayAdapterBase<JSONObject> {

    public ResumeTrainAdapter(Context context) {
        super(context);
    }
    ...
    protected View getExView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvTitle.setText(jsonObject.optString("traintime"));
        viewHolder.tvContent.setText(jsonObject.optString("trainDept") + "\n" + jsonObject.optString("trainCourse") + "\n" + jsonObject.optString("trainCert"));
        return convertView;
    }
