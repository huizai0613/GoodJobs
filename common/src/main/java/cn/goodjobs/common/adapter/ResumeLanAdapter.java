 ...
 */
public class ResumeLanAdapter extends JsonArrayAdapterBase<JSONObject> {

    public ResumeLanAdapter(Context context) {
        super(context);
    }
    ...
    protected View getExView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvTitle.setText(jsonObject.optString("languageName"));
        viewHolder.tvContent.setText(jsonObject.optString("levelName"));
        return convertView;
    }
