...
public class ExpandTabView extends LinearLayout implements OnDismissListener
{
    ...
    private OnExpandTabDismissListener mOnExpandTabDismissListener;
    ...
    public void setmOnExpandTabDismissListener(OnExpandTabDismissListener mOnExpandTabDismissListener)
    {
        this.mOnExpandTabDismissListener = mOnExpandTabDismissListener;
    }
     ...
     * 设置tabitem的个数和初始值
     */
    public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray, ArrayList<Integer> mToggleButtonH)
    {
        if (mContext == null) {
            return;
        }
        ...
        for (int i = 0; i < viewArray.size(); i++) {
            ...
            int maxHeight = mToggleButtonH.get(i);
            RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, maxHeight);
            r.addView(viewArray.get(i), rl);
            viewArray.get(i).setTag(this);
            mViewArray.add(r);
            r.setTag(SMALL);
            View view = inflater.inflate(R.layout.v_toggle_button, this, false);
            ToggleButton tButton = (ToggleButton) view.findViewById(R.id.btn_toggle);
            addView(view);
            View line = new TextView(mContext);

            line.setBackgroundColor(getContext().getResources().getColor(R.color.line_color));
...
//            tButton.setMaxEms(2);
    ...
    private void showPopup(int position)
    {
        ...
        if (tView instanceof MultiLevelMenuViewBaseAction) {
            MultiLevelMenuViewBaseAction f = (MultiLevelMenuViewBaseAction) tView;
            f.show();
        }
        ...
        popupWindow.setOnDismissListener(new OnDismissListener()
        {
            ...
            {
                if (mOnExpandTabDismissListener != null) {
                    mOnExpandTabDismissListener.expandTabDismiss(oldSelectPosition);
                }
            }
        });
    ...
    public interface OnExpandTabDismissListener
    {
