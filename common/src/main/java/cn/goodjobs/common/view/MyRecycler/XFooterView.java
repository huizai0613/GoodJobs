...
//        temp.setIndeterminateDrawable(context.getResources().getDrawable(R.drawable.iamge_progress));
        ...
        RelativeLayout.LayoutParams progressParams = new RelativeLayout.LayoutParams(DensityUtil.dip2px(context, 30),
...
//        ((ProgressBar) mProgressBar).setIndeterminateDrawable(context.getResources().getDrawable(
//                R.drawable.iamge_progress));
        mProgressBar.setVisibility(View.INVISIBLE) ;
