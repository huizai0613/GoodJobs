...
public class MyImageView extends ImageView {
	...
	public MainMenuEntity curMenuEntity;
...
//		NinePatchDrawable drawable = (NinePatchDrawable) getDrawable();
		
//		View view = LayoutInflater.from(context).inflate(R.layout.main_memu_image_top, null);
//		LayoutParams params = new LayoutParams(vWidth, vHeight);
//		view.setLayoutParams(params);
		if (view != null) {
			setImageBitmap(convertViewToBitmap(view));
		}
//		if (bitmap != null) {
...
//	}
	...
	public interface OnViewClick {
		public void onClick(MainMenuEntity curMenuEntity);
	}
