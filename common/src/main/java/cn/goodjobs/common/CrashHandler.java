...
// 使用Toast来显示异常信息
        new Thread()
        {
            ...
            {
                Looper.prepare();
//                ToastUtils.Infotoast(mContext, ex.getMessage());
//                ToastUtils.Errortoast(mContext, "亲!(T.T)程序出错了,程序猿们会尽快处理,抱歉!!");
                Looper.loop();
            }
        }.start();
// 收集设备参数信息
...
// 保存日志文件
    ...
    private String saveCrashInfo2File(Throwable ex)
    {
        ...
        try {
            ...
            String fileName = "crash-" + mobileName + "-" + time + "-"
                    + timestamp + ".log";
...
//
// HttpPost post=new HttpPost(AndroidConfig.NETHOST+AndroidConfig.UPLOAD);
//
//
// }
